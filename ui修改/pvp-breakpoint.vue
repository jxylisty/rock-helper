    ...
    <scroll-view scroll-y class="page-scroll" enhanced show-scrollbar="false">
      ...
      <view class="buff-section card">
        ...
        <view class="buff-grid">
          <view class="buff-item">
            <text class="buff-label">增伤 %</text>
            ...
            <text class="buff-note">范围：10-990%</text>
          </view>
          <view class="buff-item">
            <text class="buff-label">减伤 %</text>
            <view class="buff-input-wrap">
              <input
            ...
            <text class="buff-note">范围：10-100%</text>
          </view>
        </view>
      </view>
...
export default {
  ...
  methods: {
    ...
    calculateDamage() {
      ...
      // 计算增伤倍率 (10-990%)
      const buffPercent = Number(this.damageBuff || 0)
      const powerBuff = buffPercent ? 1 + buffPercent / 100 : 1
      ...
      const result = calculateDamageFull({
        ...
        attackerAttrs: this.attackTypes,
